...
const Header:React.FC<HeaderProps> = () => {
    ...
    return <div className='border-b border-[#E5E5E0] justify-center pt-5  pb-6 pl-4 pr-4 w-[375] h-32 mt-2 gap-4 '>
       ...
       <img src={edit} alt="" />
        ...
        <div className='w-80 h-12 gap-3 flex mt-5 items-center align-middle justify-between'>
        <img src={grp} alt="" />
        ...
        <div className=''><img  src={three} alt="" /></div>
        </div>
    </div>
}
